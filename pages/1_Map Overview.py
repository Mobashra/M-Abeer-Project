...
# Load Data
df = utils.load_elhub_data() # Loads ALL years (2021-2024)
...
fig = px.choropleth_mapbox(
    df_map, geojson=geojson, locations='price_area', featureidkey="properties.omrNr",
    color='production_mwh', color_continuous_scale="Viridis", mapbox_style="carto-positron",
    zoom=4, center={"lat": 65, "lon": 15}, opacity=0.5
)
