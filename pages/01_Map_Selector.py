...
with c_map:
    ...
    # This ensures "NO 1" is shown on hover
    if not df.empty:
    ...
    # Convert "NO1" (State) to "NO 1" (Map Format) for the Highlight
    ...
    # --- LAYER 5: RED PIN (Exact Click Location) ---
    ...
    if event and "selection" in event and event["selection"]["points"]:
        ...
        if "lat" in point:
            ...
            if hit_id:
                # FIX: Convert "NO 1" -> "NO1" (Remove space)
        ...
        # 2. REGION (Fallback for empty space clicks)
        elif "location" in point:
            # FIX: Convert "NO 1" -> "NO1"
